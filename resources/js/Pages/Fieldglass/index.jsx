...
export default function Index({ jobs, filters, statuses, sites }) {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            router.get(route('fieldglass.index'), {
                search,
                status,
                site
            }, {
    ...
    return (
        <AuthenticatedLayout
            header="Fieldglass Job Listings"
        >
            <Head title="Fieldglass Jobs" />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-zinc-400 mt-1">
                            Showing {jobs.from}-{jobs.to} of {jobs.total} jobs from Fieldglass.
                        </p>
                    </div>
                </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-zinc-800 bg-zinc-900/50">
                                    ...
                                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-zinc-400">Company / Dept</th>
                                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-zinc-400">Status</th>
                                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-zinc-400">Bill Rate</th>
                            ...
                            <tbody className="divide-y divide-zinc-800">
                                {jobs.data.map((job) => (
                                    <tr key={job.id} className="hover:bg-zinc-900/40 transition-colors group">
                                        ...
                                        <td className="px-6 py-5">
                                            <span className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${job.status?.toLowerCase().includes('active')
                                        ...
                                        <td className="px-6 py-5">
                                            <Link 
                                                href={route('all-jobs.show', { portal: 'Fieldglass', id: job.job_id })}
