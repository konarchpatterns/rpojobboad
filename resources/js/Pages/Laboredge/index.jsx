...
export default function Index({ jobs, filters, statuses, professions }) {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            router.get(route('laboredge.index'), {
                search,
                status,
                profession
            }, {
    ...
    return (
        <AuthenticatedLayout
            header="Laboredge Job Listings"
        >
            <Head title="Laboredge Jobs" />
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-zinc-400 mt-1">
                            Showing {jobs.from}-{jobs.to} of {jobs.total} jobs from Laboredge.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-zinc-900/50 p-4 rounded-xl border border-zinc-800">
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder="Search profession, facility, ID..."
                            ...
                            <tbody className="divide-y divide-zinc-800">
                                {jobs.data.map((job) => (
                                    <tr key={job.id} className="hover:bg-zinc-900/40 transition-colors group">
                                        ...
                                        <td className="px-6 py-5">
                                            <Link 
                                                href={route('all-jobs.show', { portal: 'Laboredge', id: job.job_id })}
