                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-zinc-800 bg-zinc-900/50">
                                    ...
                                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-zinc-400">Job Type</th>
                                    ...
                                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-zinc-400">Bill Due Date</th>
                                    <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-zinc-400">Last Updated</th>
                            ...
                            <tbody className="divide-y divide-zinc-800">
                                {jobs.data.map((job) => (
                                    <tr key={job.id} className="hover:bg-zinc-900/40 transition-colors group">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-[10px] text-indigo-400 hover:text-indigo-300 hover:underline font-medium ml-1"
                                                    >
                                                        View Details
                                                    </button>
                                                </div>
                                        ...
                                        <td className="px-6 py-5">
                                            <Link 
                                                href={route('all-jobs.show', { portal: 'Trovms', id: job.job_id })}
