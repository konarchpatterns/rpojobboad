...
export default function Index({ jobs, filters, statuses, departments }) {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            router.get(route('westway.index'), { 
                search, 
                status, 
                department 
            }, {
    ...
    return (
        <AuthenticatedLayout
            header="Westway Job Listings"
        >
            <Head title="Westway Jobs" />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-zinc-400 mt-1">
                            Showing {jobs.from}-{jobs.to} of {jobs.total} jobs from Westway.
                        </p>
                    </div>
                </div>
                            ...
                            <tbody className="divide-y divide-zinc-800">
                                {jobs.data.map((job) => (
                                    <tr key={job.id} className="hover:bg-zinc-900/40 transition-colors group">
                                        ...
                                        <td className="px-6 py-5">
                                            <Link 
                                                href={route('all-jobs.show', { portal: 'Westway', id: job.job_id })}
